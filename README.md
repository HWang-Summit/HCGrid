...
<p  href="https://www.codecogs.com/eqnedit.php?latex=T_{max}&space;=&space;(Register_{num})&space;/&space;184" target="_blank"><img src="https://latex.codecogs.com/gif.latex?T_{max}&space;=&space;(Register_{num})&space;/&space;184" title="T_{max} = (Register_{num}) / 184" /></a> 
...
<P align="center"><img src=pic/Source-1_H.png width="50%"></img></p>
